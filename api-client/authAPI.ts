import { _deleteApi, _getApi, _postApi, _putApi } from "api-client/axiosClient";
import { LoginPaypoad, User, UserRegister } from "models";
import { API_REGISTER, API_SIGNIN, API_USERS } from "routes";
